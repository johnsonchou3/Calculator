...
namespace Calculator
{
    ...
    public class BracketOp : Btns
    {
        ...
        public BracketOp (string bracket) 
        {
        ...
        {
            string url = "https://localhost:44375/api/Math/BracketOp?bracket=" + System.Web.HttpUtility.UrlEncode(bracket);
